...
/// willDisplayCell
- (void)pagerView:(TYCyclePagerView *)pageView willDisplayCell:(__kindof UICollectionViewCell *)cell forIndex:(NSInteger)index;

/// willDisplayCell
- (void)pagerView:(TYCyclePagerView *)pageView didEndDisplayingCell:(__kindof UICollectionViewCell *)cell forIndex:(NSInteger)index;

/**
 pagerView did scroll to new index page
 */
- (void)pagerView:(TYCyclePagerView *)pageView didScrollFromIndex:(NSInteger)fromIndex toIndex:(NSInteger)toIndex;
- (void)pagerView:(TYCyclePagerView *)pageView didScrollFromIndexSection:(TYIndexSection)fromIndexSection toIndexSection:(TYIndexSection)toIndexSection;
...
// reloadData will reset index zero , default NO
@property (nonatomic, assign) BOOL reloadDataNeedResetIndex;
@property (nonatomic, assign) BOOL ignoreScrollMiddleIndex;
/**
 current page index
 */
