...
typedef NS_ENUM(NSUInteger, TYCyclePagerLayoutAlign) {
    TYCyclePagerLayoutAlignCenter,
    TYCyclePagerLayoutAlignLeft
};
...
// show item align center or left
@property (nonatomic, assign) TYCyclePagerLayoutAlign itemAlign;
