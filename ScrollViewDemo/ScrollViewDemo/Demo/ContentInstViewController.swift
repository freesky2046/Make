//
//  ContentInstViewController.swift
//  ScrollViewDemo
//
...
class ContentInstViewController: UIViewController, UIScrollViewDelegate {

    override func viewDidLoad() {
        super.viewDidLoad()
        view.backgroundColor = .white
        
        let scrollView = UIScrollView(frame: CGRect(x: 0, y: 188, width: UIScreen.main.bounds.size.width, height: 200))
